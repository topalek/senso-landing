...
//  Parallax Background Image
    ...
    $('.order').on('click', e => {
        ...
        hiddenInput.setAttribute('name', 'order[title]');
        hiddenInput.setAttribute('value', orderName);
        $('#form-contact').append(hiddenInput);
    });
...
function oneClickValidate(e) {
    // e.preventDefault();
    let errors = [];
    console.log('order-oneClickValidate');

    $('#oneClick input').not('[type="hidden"]').each((i, el) => {
        if (!$(el).val()) {
            $(el).parents('.form-group').addClass('error');
            $(el).addClass('error');
            errors[i] = "Заполните " + $(el).data('name');
        } else {
...
function orderValidate(e) {
    ...
    $('#form-contact input,textarea').not('[type="hidden"]').each((i, el) => {
        if (!$(el).val()) {
            $(el).parents('.form-group').addClass('error');
            $(el).addClass('error');
            errors[i] = "Заполните " + $(el).data('name');
